...
contract ROYALBEES is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address Staking = 0xA0f541732230fdd810D6a45F97EF864E278AC209;

    string constant _name = "RoyalBees";
    string constant _symbol = "RBs";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 888880000 * (10 ** _decimals); 
    ...
    uint256 RBRewardPool = 2;

    uint256 totalBuyFee = liquidityFee + StakingFee + marketingFee + RBRewardPool;
    uint256 totalSellFee = 6;
    uint256 feeDenominator = 100;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;
    address public RBRewardPoolFeeReceiver;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xdf6d3D61859d90d5ad53551445a1D34FDBdE243C;
        marketingFeeReceiver = 0xf8047EeeF8B269b85e89FDe730913c4aE0Eb2150;
        RBRewardPoolFeeReceiver = 0x2d0A8a634a6A28659573F20da0f02e0a77aF40A9;
    ...
    function swapBack() internal swapping {
        ...
        try router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            uint256 amountRBRewardPool = amountBNB.mul(RBRewardPool).div(totalBNBFee);

            (bool success, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
            ( success, /* bytes memory data */) = payable(RBRewardPoolFeeReceiver).call{value: amountRBRewardPool, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _StakingFee, uint256 _marketingFee, uint256 _RBRewardPool, uint256 _feeDenominator, uint256 _totalSellFee) external authorized() {
        liquidityFee = _liquidityFee;
        StakingFee = _StakingFee;
        marketingFee = _marketingFee;
        RBRewardPool = _RBRewardPool;
        totalBuyFee = _liquidityFee + _StakingFee + _marketingFee +_RBRewardPool ;
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _RBRewardPoolFeeReceiver) external authorized(){
        autoLiquidityReceiver = _autoLiquidityReceiver;
        marketingFeeReceiver = _marketingFeeReceiver;
        RBRewardPoolFeeReceiver = _RBRewardPoolFeeReceiver;
    }
